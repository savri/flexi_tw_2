	...
	<?php echo form_open(current_url()); ?>  	
		...
		<fieldset>
			...
			<ul>
				...
				<li>							
					<small>
						Password length must be at least 
								...
								characters in length.<br/>Only alpha-numeric, dashes, underscores, 
								periods and comma characters are allowed.
					</small>
				</li>
				<li class="info_req">
					<label for="pri_p_pw">Password:</label>
					<input type="password" id="pri_p_pw" name="register_pri_p_pw" 
									value="<?php echo set_value('register_pri_p_pw');?>"/>
					(required)
				</li>
				<li class="info_req">
					<label for="pri_p_confirm_pw">Confirm Password:</label>
					<input type="password" id="pri_p_confirm_pw" name="register_pri_p_confirm_pw" 
									value="<?php echo set_value('register_pri_p_confirm_pw');?>"/>
					(required)
				</li>
				<li class="info_req">
				...
				<li class="info_req">
					<label for="alt_p_pw">Password:</label>
					<input type="password" id="alt_p_pw" name="register_alt_p_pw" 
									value="<?php echo set_value('register_alt_p_pw');?>"/>
				</li>
				<li class="info_req">
					<label for="alt_p_confirm_pw">Confirm Password:</label>
					<input type="password" id="alt_p_confirm_pw" name="register_alt_p_confirm_pw" 
									value="<?php echo set_value('register_alt_p_confirm_pw');?>"/>
				</li>
		...
		<fieldset>
			...
			<li class="info_req">
				...
				<li class="info_req">
					<label for="s_email">Student Contact Email</label>
				...
				<li class="info_req">
					...
					(required)
						<?php
							...
							echo form_dropdown('s_ttype',$options,'',$js);
						?>
				</li>			
				<br/>
			</ul>
