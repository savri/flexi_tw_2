...
class Auth_lite extends CI_Controller {
    ...
    function __construct() 
    {
		...
		$this->firephp->log("Auth lite loading");
		...
		$this->load->vars('base_url', 'http://localhost/PHP-Exercises/FlexiAuth/testwell/');
		$this->load->vars('includes_dir', 'http://localhost/PHP-Exercises/FlexiAuth/testwell/includes/');
