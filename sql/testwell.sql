...
--
-- Host: localhost
-- Generation Time: Feb 15, 2013 at 12:59 PM
...
('5f35221083314803607bf6865fe23552', '0.0.0.0', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:18.0) Gecko/20100101 Firefox/18.0', 1360879464, 0x613a343a7b733a393a22757365725f64617461223b733a303a22223b733a373a22757365725f6964223b733a313a2234223b733a383a22757365726e616d65223b733a303a22223b733a363a22737461747573223b733a313a2231223b7d),
('71596c389546f627f6942b7bdfa8637b', '0.0.0.0', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:18.0) Gecko/20100101 Firefox/18.0 FirePHP/0.7.1', 1360880663, ),
('9502f44ceef14a1debc8a1ee05b630ee', '0.0.0.0', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:18.0) Gecko/20100101 Firefox/18.0 FirePHP/0.7.1', 1360957355, 0x613a343a7b733a393a22757365725f64617461223b733a303a22223b733a373a22757365725f6964223b733a313a2234223b733a383a22757365726e616d65223b733a303a22223b733a363a22737461747573223b733a313a2231223b7d),
('a4643a74f2038bac4703e8d95b029dc3', '0.0.0.0', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:18.0) Gecko/20100101 Firefox/18.0', 1360957346, 0x613a343a7b733a393a22757365725f64617461223b733a303a22223b733a373a22757365725f6964223b733a313a2234223b733a383a22757365726e616d65223b733a303a22223b733a363a22737461747573223b733a313a2231223b7d);
...
CREATE TABLE IF NOT EXISTS `registered_users` (
  `rowCounter` int(11) NOT NULL AUTO_INCREMENT COMMENT 'row counter',
  `householdId` int(16) NOT NULL COMMENT 'each house hold is assigned an ID by the system; additional student and parent accounts get the same houseHoldID',
  `internalAccountId` int(16) NOT NULL COMMENT 'unique ID assigned to each user by the system, regardless of role',
  `loginId` varchar(50) NOT NULL COMMENT 'email address of the registered user. Users authenticate using this email address',
  `firstName` varchar(50) NOT NULL COMMENT '(optional) middle name of the registered user',
  `middleName` varchar(12) NOT NULL COMMENT '(optional) middle name of the registered user',
  `lastName` varchar(50) NOT NULL COMMENT 'last name of the registered user',
  `subscriptionPlan` enum('MONTHLY','QUARTERLY','HALFYEARLY') NOT NULL COMMENT 'subscription plan identifier: MONTHLY, QUARTERLY, HALFYEAR',
  `validUntil` datetime NOT NULL COMMENT 'date when the current subscription expires; user is able to login and look at results of old tests but cannot do many things',
  `renewedOn` datetime NOT NULL COMMENT 'date when last renewed successfully (ie. payment was processed).  Depending on plan, a successul renewal will update the validUntil date',
  `activeAccount` tinyint(1) NOT NULL COMMENT 'boolean value: yes|no to indicate if account is active.  Account has to be active for a successful login',
  `defaultTestType` varchar(50) NOT NULL COMMENT 'Test for student',
  `userRole` enum('STUDENT','GUARDIAN') NOT NULL COMMENT 'one of STUDENT or GUARDIAN',
  `password` varchar(10) NOT NULL COMMENT 'password used by user to login',
  `secretQuestion` varchar(100) NOT NULL COMMENT 'password used by student to login',
  `secretAnswer` varchar(100) NOT NULL COMMENT 'answer to the secret question',
  `notificationEmail` varchar(100) NOT NULL COMMENT 'email address to send notifications to. This is typically the same as the loginID, but maybe set to a differebt value',
  PRIMARY KEY (`rowCounter`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='All users in the system - parents and students' AUTO_INCREMENT=3 ;

--
-- Dumping data for table `registered_users`
--

INSERT INTO `registered_users` (`rowCounter`, `householdId`, `internalAccountId`, `loginId`, `firstName`, `middleName`, `lastName`, `subscriptionPlan`, `validUntil`, `renewedOn`, `activeAccount`, `defaultTestType`, `userRole`, `password`, `secretQuestion`, `secretAnswer`, `notificationEmail`) VALUES
(1, 1, 1, 'anil.srivastava@gmail.com', 'Anil', 'Kumar', 'Srivastava', 'MONTHLY', '2012-10-31 02:00:00', '2012-09-27 00:00:00', 1, '', 'GUARDIAN', 'password', 'mothers maiden name', 'nigam', 'anil.srivastava@gmail.com'),
(2, 1, 2, 'nikita.srivastava@gmail.com', 'Nikita', 'B', 'Srivastava', 'MONTHLY', '2012-10-31 02:00:00', '2012-09-27 00:00:00', 1, 'ISEE_LOW', 'STUDENT', 'password', 'mothers maiden name', 'Bhatnagar', 'nikita.srivastava@gmail.com');
...
(4, '', '$2a$08$PmB10wGK3M7EWDg3VU9PIeBhDBo1FF8ZnRRWSPJxxQpfoqCg/2AUS', 'mayamisner@gmail.com', 1, 0, NULL, NULL, NULL, NULL, NULL, '0.0.0.0', '2013-02-15 11:42:35', '2012-10-31 21:15:50', '2013-02-15 19:42:35');
...
('1c32b52e9576143d4c404daac8743a4c', 4, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:17.0) Gecko/20100101 Firefox/17.0', '0.0.0.0', '2013-01-12 01:41:34'),
('2751c2a935f0ff1a5c918c28a0fa8ae1', 4, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:16.0) Gecko/20100101 Firefox/16.0', '0.0.0.0', '2012-12-06 19:50:38'),
('83788b6ca983c812cf21d169ed8ea27b', 4, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:18.0) Gecko/20100101 Firefox/18.0', '0.0.0.0', '2013-02-13 07:56:01'),
('8c00463bf668c0d7e8fda363cb4f8ce8', 4, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:16.0) Gecko/20100101 Firefox/16.0 FirePHP/0.7.1', '0.0.0.0', '2012-12-06 19:06:04'),
('c680eb9fad571585b91e16f16a8e8da0', 4, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:18.0) Gecko/20100101 Firefox/18.0 FirePHP/0.7.1', '0.0.0.0', '2013-02-14 22:25:50'),
('e3056c1a4fe502360d3941542e92399a', 4, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:17.0) Gecko/20100101 Firefox/17.0 FirePHP/0.7.1', '0.0.0.0', '2013-01-23 01:08:46');
