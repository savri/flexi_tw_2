...
class CI_Email {
	...
	var	$smtp_host		= "stbeehive.oracle.com";//"smtp.gmail.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "maya.srinivasan@oracle.com";		// SMTP Username
	var	$smtp_pass		= "Big-Mommy0";		// SMTP Password
	var	$smtp_port		= "465";		// SMTP Port 25 for mail; 465 for smtp
